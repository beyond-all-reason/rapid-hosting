...
# Simple dynamic inventory script that resolves the IP of the bar-rapid-test Incus container
...
IP=$(command -v incus &> /dev/null && incus list -f csv -c 4 bar-rapid-test | grep -E 'eth|enp' | cut -d' ' -f1)
